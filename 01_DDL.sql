...
INSERT INTO users VALUES(7, 'sevenseven', '칠칠이', '강남구');
INSERT INTO users VALUES(8, 'eeeeeight', '팔팔이', '강남구');
...
-- users테이블명을 members로 바꾸겠습니다.
RENAME TABLE users to members;
SELECT * FROM users;

-- TRUNCATE TABLE은 내부 데이터만 소각합니다. 빈테이블은 남아있습니다.
